...
const TECH_STACK = ["React", "Javascript", "Node.js", "AngularJS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/dhanshree-ahire" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/dhanshree-ahire-a1030a243?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { icon: Instagram, link: "https://www.instagram.com/dhanshreeahire25" },
];
...
const Home = () => {
  ...
  // Lottie configuration - REMOVED: Now using person image
  // const lottieOptions = {
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            >
              <div className="relative w-full opacity-90">
                ...
                <div
                  className={`relative z-10 w-full max-w-md mx-auto transform transition-transform duration-500 ${
